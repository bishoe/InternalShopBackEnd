...
using InternalShop.ClassProject.ProductsSVC;
...
namespace InternalShop
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           options.UseSqlServer(Configuration.GetConnectionString("InternalShopTOCon"), x => x.MigrationsAssembly("InternalShop")));
       ...
       //options.UseSqlServer(Configuration.GetConnectionString("DataProtectionKeysContextCon"), x => x.MigrationsAssembly("InternalShop")));
         ...
         options =>
         {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "InternalShop", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "InternalShop v1"));
            }
